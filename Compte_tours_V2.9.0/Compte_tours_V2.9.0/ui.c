...
lv_img_set_src(ui_fond, &ui_img_fond_compteur_png);
...
lv_img_set_src(ui_needle, &ui_img_needle_compteur_png);
lv_obj_set_width( ui_needle, LV_SIZE_CONTENT);  /// 1
lv_obj_set_height( ui_needle, LV_SIZE_CONTENT);   /// 1
lv_obj_set_x( ui_needle, -43 );
lv_obj_set_y( ui_needle, 56 );
...
lv_img_set_pivot(ui_needle,114,11);
lv_obj_set_style_blend_mode(ui_needle, LV_BLEND_MODE_NORMAL, LV_PART_MAIN| LV_STATE_DEFAULT);
